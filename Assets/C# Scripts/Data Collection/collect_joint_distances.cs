...
// NOTE: AS A PART OF HRI VERSION II (SECOND YEAR OF MASTERS)
...
public class collect_joint_distances : MonoBehaviour
{
    ...
    private string fileName = "open_gripper_gesture.txt";
    ...
    void Start()
    {
        ...
        {
            writer.WriteLine("Time,Dist8_0,Dist12_0,Dist16_0,Dist20_0");
        }
    }
    ...
    private void addRecord(string filePath)
    {
        try
        {
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@filePath, true))
            {
                ...
                file.Write(dist8_0_rh.ToString() + ",");
